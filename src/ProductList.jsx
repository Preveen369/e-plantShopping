...
import { useDispatch, useSelector } from 'react-redux'; // Import useSelector for accessing cart state
...
function ProductList({ onHomeClick }) {
  ...
  const handleAddToCart = (plant) => {
    // Add quantity property to the plant object
    const plantWithQuantity = { ...plant, quantity: 1 };
    // Dispatch the plant object to the Redux store
    dispatch(addItem(plantWithQuantity));
    // Update local state to reflect the product was added
